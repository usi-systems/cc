...
extern PyTypeObject PyNs3DsdvHelper_Type;

class PyNs3DsdvHelper__PythonHelper : public ns3::DsdvHelper
{
public:
    PyObject *m_pyself;
    PyNs3DsdvHelper__PythonHelper(ns3::DsdvHelper const & arg0)
        : ns3::DsdvHelper(arg0), m_pyself(NULL)
        {}

    PyNs3DsdvHelper__PythonHelper()
        : ns3::DsdvHelper(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3DsdvHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    virtual ns3::DsdvHelper * Copy() const;
...
typedef struct {
    PyObject_HEAD
    ns3::dsdv::DsdvHeader *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvDsdvHeader;


extern PyTypeObject PyNs3DsdvDsdvHeader_Type;


typedef struct {
    PyObject_HEAD
    ns3::dsdv::PacketQueue *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvPacketQueue;


extern PyTypeObject PyNs3DsdvPacketQueue_Type;

extern std::map<void*, PyObject*> PyNs3DsdvPacketQueue_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::dsdv::QueueEntry *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvQueueEntry;


extern PyTypeObject PyNs3DsdvQueueEntry_Type;

extern std::map<void*, PyObject*> PyNs3DsdvQueueEntry_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::dsdv::RoutingProtocol *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvRoutingProtocol;


extern PyTypeObject PyNs3DsdvRoutingProtocol_Type;
extern PyTypeObject PyNs3DsdvRoutingProtocolMeta_Type;


typedef struct {
    PyObject_HEAD
    ns3::dsdv::RoutingTable *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvRoutingTable;


extern PyTypeObject PyNs3DsdvRoutingTable_Type;

extern std::map<void*, PyObject*> PyNs3DsdvRoutingTable_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::dsdv::RoutingTableEntry *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3DsdvRoutingTableEntry;


extern PyTypeObject PyNs3DsdvRoutingTableEntry_Type;

extern std::map<void*, PyObject*> PyNs3DsdvRoutingTableEntry_wrapper_registry;

typedef struct {
    PyObject_HEAD
    std::map< ns3::Ipv4Address, ns3::dsdv::RoutingTableEntry > *obj;
} Pystd__map__lt___ns3__Ipv4Address__ns3__dsdv__RoutingTableEntry___gt__;


typedef struct {
    PyObject_HEAD
    Pystd__map__lt___ns3__Ipv4Address__ns3__dsdv__RoutingTableEntry___gt__ *container;
    std::map< ns3::Ipv4Address, ns3::dsdv::RoutingTableEntry >::iterator *iterator;
} Pystd__map__lt___ns3__Ipv4Address__ns3__dsdv__RoutingTableEntry___gt__Iter;


extern PyTypeObject Pystd__map__lt___ns3__Ipv4Address__ns3__dsdv__RoutingTableEntry___gt___Type;
extern PyTypeObject Pystd__map__lt___ns3__Ipv4Address__ns3__dsdv__RoutingTableEntry___gt__Iter_Type;
