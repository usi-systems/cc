#include "ns3module.h"
static PyMethodDef topology_read_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef topology_read_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "topology_read.FatalImpl",
    NULL,
    -1,
    topology_read_FatalImpl_functions,
};
#endif

static PyObject *
inittopology_read_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&topology_read_FatalImpl_moduledef);
    #else
    m = Py_InitModule3((char *) "topology_read.FatalImpl", topology_read_FatalImpl_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef topology_read_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef topology_read_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "topology_read.Hash.Function",
    NULL,
    -1,
    topology_read_Hash_Function_functions,
};
#endif

static PyObject *
inittopology_read_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&topology_read_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "topology_read.Hash.Function", topology_read_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef topology_read_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef topology_read_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "topology_read.Hash",
    NULL,
    -1,
    topology_read_Hash_functions,
};
#endif

static PyObject *
inittopology_read_Hash(void)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&topology_read_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "topology_read.Hash", topology_read_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = inittopology_read_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
static PyMethodDef topology_read_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
PyObject *
_wrap_PyNs3TopologyReaderHelper_GetTopologyReader(PyNs3TopologyReaderHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
static PyObject*
_wrap_PyNs3TopologyReaderHelper__copy__(PyNs3TopologyReaderHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3TopologyReaderHelper_Type = {
    ...
    (char *) "topology_read.TopologyReaderHelper",            /* tp_name */
    ...
    "TopologyReaderHelper(arg0)\nTopologyReaderHelper()",                        /* Documentation string */
...
static int
_wrap_PyNs3TopologyReader__tp_init(void)
{
    PyErr_SetString(PyExc_TypeError, "class 'TopologyReader' cannot be constructed (have pure virtual methods but no helper class)");
    return -1;
}
...
PyObject *
_wrap_PyNs3TopologyReader_GetFileName(PyNs3TopologyReader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    std::string retval;
...
PyObject *
_wrap_PyNs3TopologyReader_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3TopologyReader_LinksEmpty(PyNs3TopologyReader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3TopologyReader_LinksSize(PyNs3TopologyReader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    int retval;
    
    retval = self->obj->LinksSize();
...
PyObject *
_wrap_PyNs3TopologyReader_SetFileName(PyNs3TopologyReader *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    ...
    self->obj->SetFileName(fileName_std);
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static void
PyNs3TopologyReader__tp_clear(PyNs3TopologyReader *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::TopologyReader *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3TopologyReader__tp_traverse(PyNs3TopologyReader *self, visitproc visit, void *arg)
{
...
static void
_wrap_PyNs3TopologyReader__tp_dealloc(PyNs3TopologyReader *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    ...
    PyNs3TopologyReader__tp_clear(self);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

PyTypeObject PyNs3TopologyReader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.TopologyReader",            /* tp_name */
    sizeof(PyNs3TopologyReader),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3TopologyReader__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3TopologyReader_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3TopologyReader, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3TopologyReader__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
std::map<void*, PyObject*> PyNs3TopologyReaderLink_wrapper_registry;


static int
_wrap_PyNs3TopologyReaderLink__tp_init__0(PyNs3TopologyReaderLink *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    PyNs3TopologyReaderLink *arg0;
    const char *keywords[] = {"arg0", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!", (char **) keywords, &PyNs3TopologyReaderLink_Type, &arg0)) {
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
    ...
    self->obj = new ns3::TopologyReader::Link(*((PyNs3TopologyReaderLink *) arg0)->obj);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
}

static int
_wrap_PyNs3TopologyReaderLink__tp_init__1(PyNs3TopologyReaderLink *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    PyNs3Node *fromPtr;
    ns3::Node *fromPtr_ptr;
    const char *fromName = NULL;
    Py_ssize_t fromName_len;
    std::string fromName_std;
    PyNs3Node *toPtr;
    ns3::Node *toPtr_ptr;
    const char *toName = NULL;
    Py_ssize_t toName_len;
    std::string toName_std;
    const char *keywords[] = {"fromPtr", "fromName", "toPtr", "toName", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!s#O!s#", (char **) keywords, &PyNs3Node_Type, &fromPtr, &fromName, &fromName_len, &PyNs3Node_Type, &toPtr, &toName, &toName_len)) {
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
    ...
    fromPtr_ptr = (fromPtr ? fromPtr->obj : NULL);
    fromName_std = std::string(fromName, fromName_len);
    toPtr_ptr = (toPtr ? toPtr->obj : NULL);
    toName_std = std::string(toName, toName_len);
    self->obj = new ns3::TopologyReader::Link(ns3::Ptr< ns3::Node  > (fromPtr_ptr), fromName_std, ns3::Ptr< ns3::Node  > (toPtr_ptr), toName_std);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
}

int _wrap_PyNs3TopologyReaderLink__tp_init(PyNs3TopologyReaderLink *self, PyObject *args, PyObject *kwargs)
{
    int retval;
    PyObject *error_list;
    PyObject *exceptions[2] = {0,};
    retval = _wrap_PyNs3TopologyReaderLink__tp_init__0(self, args, kwargs, &exceptions[0]);
    if (!exceptions[0]) {
        return retval;
    }
    retval = _wrap_PyNs3TopologyReaderLink__tp_init__1(self, args, kwargs, &exceptions[1]);
    if (!exceptions[1]) {
        Py_DECREF(exceptions[0]);
        return retval;
    }
...
PyObject *
_wrap_PyNs3TopologyReaderLink_GetFromNode(PyNs3TopologyReaderLink *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3TopologyReaderLink_GetFromNodeName(PyNs3TopologyReaderLink *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    std::string retval;
    
    retval = self->obj->GetFromNodeName();
    py_retval = Py_BuildValue((char *) "s#", (retval).c_str(), (retval).size());
    return py_retval;
}
...
PyObject *
_wrap_PyNs3TopologyReaderLink_GetToNode(PyNs3TopologyReaderLink *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::Ptr< ns3::Node > retval;
    PyNs3Node *py_Node;
...
PyObject *
_wrap_PyNs3TopologyReaderLink_GetToNodeName(PyNs3TopologyReaderLink *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    std::string retval;
...
static PyObject*
_wrap_PyNs3TopologyReaderLink__copy__(PyNs3TopologyReaderLink *self, PyObject *PYBINDGEN_UNUSED(_args))
{

    PyNs3TopologyReaderLink *py_copy;
    py_copy = PyObject_New(PyNs3TopologyReaderLink, &PyNs3TopologyReaderLink_Type);
    py_copy->obj = new ns3::TopologyReader::Link(*self->obj);
    py_copy->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    PyNs3TopologyReaderLink_wrapper_registry[(void *) py_copy->obj] = (PyObject *) py_copy;
    return (PyObject*) py_copy;
}
...
static void
_wrap_PyNs3TopologyReaderLink__tp_dealloc(PyNs3TopologyReaderLink *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    wrapper_lookup_iter = PyNs3TopologyReaderLink_wrapper_registry.find((void *) self->obj);
    if (wrapper_lookup_iter != PyNs3TopologyReaderLink_wrapper_registry.end()) {
        PyNs3TopologyReaderLink_wrapper_registry.erase(wrapper_lookup_iter);
    }
    
        ns3::TopologyReader::Link *tmp = self->obj;
        self->obj = NULL;
        if (!(self->flags&PYBINDGEN_WRAPPER_FLAG_OBJECT_NOT_OWNED)) {
            delete tmp;
        }
...
PyTypeObject PyNs3TopologyReaderLink_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.TopologyReader.Link",            /* tp_name */
    sizeof(PyNs3TopologyReaderLink),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3TopologyReaderLink__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "Link(fromPtr, fromName, toPtr, toName)\nLink(arg0)",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3TopologyReaderLink_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    ...
    (descrsetfunc)NULL,    /* tp_descr_set */
    0,                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3TopologyReaderLink__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
static int
_wrap_PyNs3InetTopologyReader__tp_init(PyNs3InetTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {NULL};
    ...
    self->obj = new ns3::InetTopologyReader();
    self->obj->Ref ();
...
PyObject *
_wrap_PyNs3InetTopologyReader_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static void
PyNs3InetTopologyReader__tp_clear(PyNs3InetTopologyReader *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::InetTopologyReader *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3InetTopologyReader__tp_traverse(PyNs3InetTopologyReader *self, visitproc visit, void *arg)
{
    Py_VISIT(self->inst_dict);
...
static void
_wrap_PyNs3InetTopologyReader__tp_dealloc(PyNs3InetTopologyReader *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    wrapper_lookup_iter = PyNs3ObjectBase_wrapper_registry.find((void *) self->obj);
    if (wrapper_lookup_iter != PyNs3ObjectBase_wrapper_registry.end()) {
    ...
    PyNs3InetTopologyReader__tp_clear(self);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

PyTypeObject PyNs3InetTopologyReader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.InetTopologyReader",            /* tp_name */
    sizeof(PyNs3InetTopologyReader),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3InetTopologyReader__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3InetTopologyReader_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3InetTopologyReader, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3InetTopologyReader__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
static int
_wrap_PyNs3OrbisTopologyReader__tp_init(PyNs3OrbisTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {NULL};
    ...
    self->obj = new ns3::OrbisTopologyReader();
    self->obj->Ref ();
    ns3::CompleteConstruct(self->obj);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
...
PyObject *
_wrap_PyNs3OrbisTopologyReader_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static void
PyNs3OrbisTopologyReader__tp_clear(PyNs3OrbisTopologyReader *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::OrbisTopologyReader *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3OrbisTopologyReader__tp_traverse(PyNs3OrbisTopologyReader *self, visitproc visit, void *arg)
{
    Py_VISIT(self->inst_dict);
...
static void
_wrap_PyNs3OrbisTopologyReader__tp_dealloc(PyNs3OrbisTopologyReader *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    wrapper_lookup_iter = PyNs3ObjectBase_wrapper_registry.find((void *) self->obj);
    if (wrapper_lookup_iter != PyNs3ObjectBase_wrapper_registry.end()) {
    ...
    PyNs3OrbisTopologyReader__tp_clear(self);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

PyTypeObject PyNs3OrbisTopologyReader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.OrbisTopologyReader",            /* tp_name */
    sizeof(PyNs3OrbisTopologyReader),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3OrbisTopologyReader__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3OrbisTopologyReader_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3OrbisTopologyReader, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3OrbisTopologyReader__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
static int
_wrap_PyNs3RocketfuelTopologyReader__tp_init(PyNs3RocketfuelTopologyReader *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {NULL};
    ...
    self->obj = new ns3::RocketfuelTopologyReader();
    self->obj->Ref ();
    ns3::CompleteConstruct(self->obj);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
...
PyObject *
_wrap_PyNs3RocketfuelTopologyReader_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static void
PyNs3RocketfuelTopologyReader__tp_clear(PyNs3RocketfuelTopologyReader *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::RocketfuelTopologyReader *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3RocketfuelTopologyReader__tp_traverse(PyNs3RocketfuelTopologyReader *self, visitproc visit, void *arg)
{
    Py_VISIT(self->inst_dict);
...
static void
_wrap_PyNs3RocketfuelTopologyReader__tp_dealloc(PyNs3RocketfuelTopologyReader *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    wrapper_lookup_iter = PyNs3ObjectBase_wrapper_registry.find((void *) self->obj);
    if (wrapper_lookup_iter != PyNs3ObjectBase_wrapper_registry.end()) {
    ...
    PyNs3RocketfuelTopologyReader__tp_clear(self);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

PyTypeObject PyNs3RocketfuelTopologyReader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.RocketfuelTopologyReader",            /* tp_name */
    sizeof(PyNs3RocketfuelTopologyReader),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3RocketfuelTopologyReader__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3RocketfuelTopologyReader_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3RocketfuelTopologyReader, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3RocketfuelTopologyReader__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__std__string___gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.Std__map__lt___std__string__std__string___gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__std__string___gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "topology_read.Std__map__lt___std__string__std__string___gt__Iter",            /* tp_name */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef topology_read_moduledef = {
    PyModuleDef_HEAD_INIT,
    "topology_read",
    NULL,
    -1,
    topology_read_functions,
};
#endif
...
MOD_INIT(topology_read)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&topology_read_moduledef);
    #else
    m = Py_InitModule3((char *) "topology_read", topology_read_functions, NULL);
    #endif
    if (m == NULL) {
        return MOD_ERROR;
    }
    ...
    PyModule_AddObject(m, (char *) "_PyNs3TopologyReaderHelper_wrapper_registry", PyCObject_FromVoidPtr(&PyNs3TopologyReaderHelper_wrapper_registry, NULL));
    ...
    PyModule_AddObject(m, (char *) "_PyNs3TopologyReaderLink_wrapper_registry", PyCObject_FromVoidPtr(&PyNs3TopologyReaderLink_wrapper_registry, NULL));
    ...
    submodule = inittopology_read_FatalImpl();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "FatalImpl", submodule);
    submodule = inittopology_read_Hash();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
