...
typedef struct {
    ...
    PyBindGenWrapperFlags flags:8;
} PyNs3DefaultDeleter__Ns3FdReader;


extern PyTypeObject *_PyNs3DefaultDeleter__Ns3FdReader_Type;
#define PyNs3DefaultDeleter__Ns3FdReader_Type (*_PyNs3DefaultDeleter__Ns3FdReader_Type)

extern std::map<void*, PyObject*> *_PyNs3DefaultDeleter__Ns3FdReader_wrapper_registry;
#define PyNs3DefaultDeleter__Ns3FdReader_wrapper_registry (*_PyNs3DefaultDeleter__Ns3FdReader_wrapper_registry)
...
extern PyTypeObject *_PyNs3DefaultDeleter__Ns3SystemThread_Type;
#define PyNs3DefaultDeleter__Ns3SystemThread_Type (*_PyNs3DefaultDeleter__Ns3SystemThread_Type)

extern std::map<void*, PyObject*> *_PyNs3DefaultDeleter__Ns3SystemThread_wrapper_registry;
#define PyNs3DefaultDeleter__Ns3SystemThread_wrapper_registry (*_PyNs3DefaultDeleter__Ns3SystemThread_wrapper_registry)
...
extern PyTypeObject *_PyNs3CallbackImpl__Void_Unsigned_char___star___Long_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type;
#define PyNs3CallbackImpl__Void_Unsigned_char___star___Long_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type (*_PyNs3CallbackImpl__Void_Unsigned_char___star___Long_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type)
...
typedef struct {
    PyObject_HEAD
    ns3::EmuFdNetDeviceHelper *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3EmuFdNetDeviceHelper;


extern PyTypeObject PyNs3EmuFdNetDeviceHelper_Type;

class PyNs3EmuFdNetDeviceHelper__PythonHelper : public ns3::EmuFdNetDeviceHelper
{
public:
    PyObject *m_pyself;
    PyNs3EmuFdNetDeviceHelper__PythonHelper(ns3::EmuFdNetDeviceHelper const & arg0)
        : ns3::EmuFdNetDeviceHelper(arg0), m_pyself(NULL)
        {}

    PyNs3EmuFdNetDeviceHelper__PythonHelper()
        : ns3::EmuFdNetDeviceHelper(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3EmuFdNetDeviceHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    static PyObject * _wrap_CreateFileDescriptor(PyNs3EmuFdNetDeviceHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    ...
    virtual void SetFileDescriptor(ns3::Ptr< ns3::FdNetDevice > device) const;
...
typedef struct {
    PyObject_HEAD
    ns3::TapFdNetDeviceHelper *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3TapFdNetDeviceHelper;


extern PyTypeObject PyNs3TapFdNetDeviceHelper_Type;

class PyNs3TapFdNetDeviceHelper__PythonHelper : public ns3::TapFdNetDeviceHelper
{
public:
    PyObject *m_pyself;
    PyNs3TapFdNetDeviceHelper__PythonHelper(ns3::TapFdNetDeviceHelper const & arg0)
        : ns3::TapFdNetDeviceHelper(arg0), m_pyself(NULL)
        {}

    PyNs3TapFdNetDeviceHelper__PythonHelper()
        : ns3::TapFdNetDeviceHelper(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3TapFdNetDeviceHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    static PyObject * _wrap_CreateFileDescriptor(PyNs3TapFdNetDeviceHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    inline int CreateFileDescriptor__parent_caller()
