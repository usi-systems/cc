#include "ns3module.h"
static PyMethodDef csma_layout_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef csma_layout_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "csma_layout.FatalImpl",
    NULL,
    -1,
    csma_layout_FatalImpl_functions,
};
#endif

static PyObject *
initcsma_layout_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&csma_layout_FatalImpl_moduledef);
    #else
    m = Py_InitModule3((char *) "csma_layout.FatalImpl", csma_layout_FatalImpl_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef csma_layout_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef csma_layout_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "csma_layout.Hash.Function",
    NULL,
    -1,
    csma_layout_Hash_Function_functions,
};
#endif

static PyObject *
initcsma_layout_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&csma_layout_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "csma_layout.Hash.Function", csma_layout_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef csma_layout_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef csma_layout_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "csma_layout.Hash",
    NULL,
    -1,
    csma_layout_Hash_functions,
};
#endif

static PyObject *
initcsma_layout_Hash(void)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&csma_layout_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "csma_layout.Hash", csma_layout_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = initcsma_layout_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
static PyMethodDef csma_layout_TracedValueCallback_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef csma_layout_TracedValueCallback_moduledef = {
    PyModuleDef_HEAD_INIT,
    "csma_layout.TracedValueCallback",
    NULL,
    -1,
    csma_layout_TracedValueCallback_functions,
};
#endif

static PyObject *
initcsma_layout_TracedValueCallback(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&csma_layout_TracedValueCallback_moduledef);
    #else
    m = Py_InitModule3((char *) "csma_layout.TracedValueCallback", csma_layout_TracedValueCallback_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef csma_layout_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
PyTypeObject *_PyNs3CsmaDeviceRec_Type;
std::map<void*, PyObject*> *_PyNs3CsmaDeviceRec_wrapper_registry;
...
PyTypeObject *_PyNs3Ipv6AddressGenerator_Type;
std::map<void*, PyObject*> *_PyNs3Ipv6AddressGenerator_wrapper_registry;
...
PyTypeObject *_PyNs3CsmaHelper_Type;
...
PyTypeObject *_PyNs3CsmaChannel_Type;
...
PyObject *
_wrap_PyNs3CsmaStarHelper_GetHub(PyNs3CsmaStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3CsmaStarHelper_GetHubDevices(PyNs3CsmaStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3CsmaStarHelper_GetSpokeDevices(PyNs3CsmaStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3NetDeviceContainer *py_NetDeviceContainer;
...
PyObject *
_wrap_PyNs3CsmaStarHelper_GetSpokeIpv6Address(PyNs3CsmaStarHelper *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    unsigned int i;
    const char *keywords[] = {"i", NULL};
...
PyObject *
_wrap_PyNs3CsmaStarHelper_SpokeCount(PyNs3CsmaStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
static PyObject*
_wrap_PyNs3CsmaStarHelper__copy__(PyNs3CsmaStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3CsmaStarHelper_Type = {
    ...
    (char *) "csma_layout.CsmaStarHelper",            /* tp_name */
    ...
    "CsmaStarHelper(numSpokes, csmaHelper)\nCsmaStarHelper(arg0)",                        /* Documentation string */
...
PyTypeObject Pystd__vector__lt___bool___gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__vector__lt___bool___gt__",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___bool___gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__vector__lt___bool___gt__Iter",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv6Address___gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__vector__lt___ns3__Ipv6Address___gt__",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv6Address___gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__vector__lt___ns3__Ipv6Address___gt__Iter",            /* tp_name */
...
PyTypeObject Pystd__map__lt___unsigned_int__unsigned_int___gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__map__lt___unsigned_int__unsigned_int___gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___unsigned_int__unsigned_int___gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "csma_layout.Std__map__lt___unsigned_int__unsigned_int___gt__Iter",            /* tp_name */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef csma_layout_moduledef = {
    PyModuleDef_HEAD_INIT,
    "csma_layout",
    NULL,
    -1,
    csma_layout_functions,
};
#endif
...
MOD_INIT(csma_layout)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&csma_layout_moduledef);
    #else
    m = Py_InitModule3((char *) "csma_layout", csma_layout_functions, NULL);
    #endif
    if (m == NULL) {
        return MOD_ERROR;
    }
    ...
    /* Import the 'ns3::CsmaDeviceRec' class from module 'ns.csma' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.csma");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3CsmaDeviceRec_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "CsmaDeviceRec");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, (char*) "_PyNs3CsmaDeviceRec_wrapper_registry");
        if (_cobj == NULL) {
            _PyNs3CsmaDeviceRec_wrapper_registry = NULL;
            PyErr_Clear();
        } else {
            _PyNs3CsmaDeviceRec_wrapper_registry = reinterpret_cast< std::map<void*, PyObject*> *> (PyCObject_AsVoidPtr (_cobj));
            Py_DECREF(_cobj);
        }
    }
    ...
    /* Import the 'ns3::Ipv6AddressGenerator' class from module 'ns.internet' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.internet");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3Ipv6AddressGenerator_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "Ipv6AddressGenerator");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, (char*) "_PyNs3Ipv6AddressGenerator_wrapper_registry");
        if (_cobj == NULL) {
            _PyNs3Ipv6AddressGenerator_wrapper_registry = NULL;
            PyErr_Clear();
        } else {
            _PyNs3Ipv6AddressGenerator_wrapper_registry = reinterpret_cast< std::map<void*, PyObject*> *> (PyCObject_AsVoidPtr (_cobj));
            Py_DECREF(_cobj);
        }
    }
    ...
    /* Import the 'ns3::CsmaHelper' class from module 'ns.csma' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.csma");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3CsmaHelper_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "CsmaHelper");
    ...
    /* Import the 'ns3::CsmaChannel' class from module 'ns.csma' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.csma");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3CsmaChannel_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "CsmaChannel");
    ...
    PyModule_AddObject(m, (char *) "_PyNs3CsmaStarHelper_wrapper_registry", PyCObject_FromVoidPtr(&PyNs3CsmaStarHelper_wrapper_registry, NULL));
    ...
    submodule = initcsma_layout_FatalImpl();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "FatalImpl", submodule);
    submodule = initcsma_layout_Hash();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "Hash", submodule);
    submodule = initcsma_layout_TracedValueCallback();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
