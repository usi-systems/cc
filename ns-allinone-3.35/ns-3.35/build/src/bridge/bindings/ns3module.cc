#include "ns3module.h"
static PyMethodDef bridge_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef bridge_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "bridge.FatalImpl",
    NULL,
    -1,
    bridge_FatalImpl_functions,
};
#endif

static PyObject *
initbridge_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&bridge_FatalImpl_moduledef);
    #else
    m = Py_InitModule3((char *) "bridge.FatalImpl", bridge_FatalImpl_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef bridge_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef bridge_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "bridge.Hash.Function",
    NULL,
    -1,
    bridge_Hash_Function_functions,
};
#endif

static PyObject *
initbridge_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&bridge_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "bridge.Hash.Function", bridge_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef bridge_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef bridge_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "bridge.Hash",
    NULL,
    -1,
    bridge_Hash_functions,
};
#endif

static PyObject *
initbridge_Hash(void)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&bridge_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "bridge.Hash", bridge_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = initbridge_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
static PyMethodDef bridge_TracedValueCallback_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef bridge_TracedValueCallback_moduledef = {
    PyModuleDef_HEAD_INIT,
    "bridge.TracedValueCallback",
    NULL,
    -1,
    bridge_TracedValueCallback_functions,
};
#endif

static PyObject *
initbridge_TracedValueCallback(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&bridge_TracedValueCallback_moduledef);
    #else
    m = Py_InitModule3((char *) "bridge.TracedValueCallback", bridge_TracedValueCallback_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef bridge_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
PyObject *
_wrap_PyNs3BridgeHelper_Install(PyNs3BridgeHelper *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    const char *nodeName;
...
static PyObject*
_wrap_PyNs3BridgeHelper__copy__(PyNs3BridgeHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3BridgeHelper_Type = {
    ...
    (char *) "bridge.BridgeHelper",            /* tp_name */
    ...
    "BridgeHelper(arg0)\nBridgeHelper()",                        /* Documentation string */
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_DoDispose(PyNs3BridgeChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_DoInitialize(PyNs3BridgeChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3BridgeChannel__PythonHelper *helper = dynamic_cast< PyNs3BridgeChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_NotifyNewAggregate(PyNs3BridgeChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3BridgeChannel__PythonHelper *helper = dynamic_cast< PyNs3BridgeChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_NotifyConstructionCompleted(PyNs3BridgeChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3BridgeChannel__PythonHelper *helper = dynamic_cast< PyNs3BridgeChannel__PythonHelper* >(self->obj);
...
PyNs3BridgeChannel__PythonHelper::GetDevice(std::size_t i) const
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::BridgeChannel *self_obj_before;
...
void
PyNs3BridgeChannel__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
static int
_wrap_PyNs3BridgeChannel__tp_init(PyNs3BridgeChannel *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {NULL};
    ...
    if (Py_TYPE(self) != &PyNs3BridgeChannel_Type)
    {
...
PyObject *
_wrap_PyNs3BridgeChannel_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3BridgeChannel_GetNDevices(PyNs3BridgeChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    std::size_t retval;
...
PyNs3BridgeChannel__tp_traverse(PyNs3BridgeChannel *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj).name() == typeid(PyNs3BridgeChannel__PythonHelper).name()  && self->obj->GetReferenceCount() == 1)
...
PyTypeObject PyNs3BridgeChannel_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "bridge.BridgeChannel",            /* tp_name */
...
static int
_wrap_PyNs3BridgeNetDevice__tp_init(PyNs3BridgeNetDevice *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {NULL};
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetAddress(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetBroadcast(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3Address *py_Address;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetChannel(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetIfIndex(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetMtu(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint16_t retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetNBridgePorts(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_IsBridge(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_IsBroadcast(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_IsLinkUp(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_IsMulticast(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_IsPointToPoint(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_NeedsArp(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3BridgeNetDevice_SupportsSendFrom(PyNs3BridgeNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
static PyMethodDef PyNs3BridgeNetDevice_methods[] = {
    ...
    {(char *) "IsBroadcast", (PyCFunction) _wrap_PyNs3BridgeNetDevice_IsBroadcast, METH_NOARGS, "IsBroadcast()\n\n" },
    {(char *) "IsLinkUp", (PyCFunction) _wrap_PyNs3BridgeNetDevice_IsLinkUp, METH_NOARGS, "IsLinkUp()\n\n" },
...
PyTypeObject PyNs3BridgeNetDevice_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "bridge.BridgeNetDevice",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "bridge.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "bridge.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef bridge_moduledef = {
    PyModuleDef_HEAD_INIT,
    "bridge",
    NULL,
    -1,
...
MOD_INIT(bridge)
{
    ...
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&bridge_moduledef);
    #else
    m = Py_InitModule3((char *) "bridge", bridge_functions, NULL);
    #endif
    if (m == NULL) {
        return MOD_ERROR;
    }
    ...
    PyModule_AddObject(m, (char *) "_PyNs3BridgeHelper_wrapper_registry", PyCObject_FromVoidPtr(&PyNs3BridgeHelper_wrapper_registry, NULL));
    ...
    submodule = initbridge_FatalImpl();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "FatalImpl", submodule);
    submodule = initbridge_Hash();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "Hash", submodule);
    submodule = initbridge_TracedValueCallback();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
