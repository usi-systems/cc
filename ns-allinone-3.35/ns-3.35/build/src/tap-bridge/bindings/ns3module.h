...
typedef struct {
    PyObject_HEAD
    ns3::TapBridgeHelper *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3TapBridgeHelper;


extern PyTypeObject PyNs3TapBridgeHelper_Type;

extern std::map<void*, PyObject*> PyNs3TapBridgeHelper_wrapper_registry;
...
extern PyTypeObject PyNs3TapBridge_Type;


typedef struct {
    PyObject_HEAD
    ns3::TapBridgeFdReader *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3TapBridgeFdReader;


extern PyTypeObject PyNs3TapBridgeFdReader_Type;
