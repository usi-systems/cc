...
PyObject *
_wrap_PyNs3PointToPointDumbbellHelper_LeftCount(PyNs3PointToPointDumbbellHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3PointToPointDumbbellHelper_RightCount(PyNs3PointToPointDumbbellHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
static PyObject*
_wrap_PyNs3PointToPointDumbbellHelper__copy__(PyNs3PointToPointDumbbellHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3PointToPointDumbbellHelper_Type = {
    ...
    "PointToPointDumbbellHelper(nLeftLeaf, leftHelper, nRightLeaf, rightHelper, bottleneckHelper)\nPointToPointDumbbellHelper(arg0)",                        /* Documentation string */
...
static PyObject*
_wrap_PyNs3PointToPointGridHelper__copy__(PyNs3PointToPointGridHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3PointToPointGridHelper_Type = {
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "PointToPointGridHelper(nRows, nCols, pointToPoint)\nPointToPointGridHelper(arg0)",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
...
PyObject *
_wrap_PyNs3PointToPointStarHelper_GetHub(PyNs3PointToPointStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::Ptr< ns3::Node > retval;
    PyNs3Node *py_Node;
...
PyObject *
_wrap_PyNs3PointToPointStarHelper_SpokeCount(PyNs3PointToPointStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
static PyObject*
_wrap_PyNs3PointToPointStarHelper__copy__(PyNs3PointToPointStarHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3PointToPointStarHelper_Type = {
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "PointToPointStarHelper(numSpokes, p2pHelper)\nPointToPointStarHelper(arg0)",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point_layout.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point_layout.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv6Address___gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point_layout.Std__vector__lt___ns3__Ipv6Address___gt__",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv6Address___gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point_layout.Std__vector__lt___ns3__Ipv6Address___gt__Iter",            /* tp_name */
