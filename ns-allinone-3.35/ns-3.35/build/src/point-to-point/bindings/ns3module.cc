...
static PyMethodDef point_to_point_internal_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef point_to_point_internal_moduledef = {
    PyModuleDef_HEAD_INIT,
    "point_to_point.internal",
    NULL,
    -1,
    point_to_point_internal_functions,
};
#endif

static PyObject *
initpoint_to_point_internal(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&point_to_point_internal_moduledef);
    #else
    m = Py_InitModule3((char *) "point_to_point.internal", point_to_point_internal_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
PyTypeObject *_PyNs3CallbackImpl__Void_Ns3Ptr__lt__const_ns3Packet__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Time_Ns3Time_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type;
...
static PyObject*
_wrap_PyNs3PointToPointHelper__copy__(PyNs3PointToPointHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyObject *
_wrap_PyNs3PppHeader_GetInstanceTypeId(PyNs3PppHeader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3PppHeader_GetProtocol(PyNs3PppHeader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint16_t retval;
...
PyObject *
_wrap_PyNs3PppHeader_GetSerializedSize(PyNs3PppHeader *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3PppHeader_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static PyObject*
_wrap_PyNs3PppHeader__copy__(PyNs3PppHeader *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_GetDelay(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyNs3PointToPointChannel__PythonHelper::_wrap_GetDestination(PyNs3PointToPointChannel *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (typeid((*const_cast<ns3::PointToPointNetDevice *> (ns3::PeekPointer (retval)))).name() == typeid(PyNs3PointToPointNetDevice__PythonHelper).name())
    {
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_IsInitialized(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointChannel__PythonHelper *helper = dynamic_cast< PyNs3PointToPointChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_DoDispose(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointChannel__PythonHelper *helper = dynamic_cast< PyNs3PointToPointChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_DoInitialize(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointChannel__PythonHelper *helper = dynamic_cast< PyNs3PointToPointChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_NotifyNewAggregate(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointChannel__PythonHelper *helper = dynamic_cast< PyNs3PointToPointChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointChannel__PythonHelper::_wrap_NotifyConstructionCompleted(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointChannel__PythonHelper *helper = dynamic_cast< PyNs3PointToPointChannel__PythonHelper* >(self->obj);
...
PyNs3PointToPointChannel__PythonHelper::GetDevice(std::size_t i) const
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
...
bool
PyNs3PointToPointChannel__PythonHelper::TransmitStart(ns3::Ptr< ns3::Packet const > p, ns3::Ptr< ns3::PointToPointNetDevice > src, ns3::Time txTime)
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::PointToPointChannel *self_obj_before;
    ...
    if (typeid(*(const_cast<ns3::PointToPointNetDevice *> (ns3::PeekPointer (src)))).name() == typeid(PyNs3PointToPointNetDevice__PythonHelper).name())
    {
...
PyObject *
_wrap_PyNs3PointToPointChannel_GetNDevices(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    std::size_t retval;
    PyNs3PointToPointChannel__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointChannel__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointChannel_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static PyObject*
_wrap_PyNs3PointToPointChannel__copy__(PyNs3PointToPointChannel *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyObject *
PyNs3PointToPointNetDevice__PythonHelper::_wrap_DoMpiReceive(PyNs3PointToPointNetDevice *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3Packet *p;
    ns3::Packet *p_ptr;
    ...
    p_ptr = (p ? p->obj : NULL);
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method DoMpiReceive of class PointToPointNetDevice is protected and can only be called by a subclass");
        return NULL;
    }
    helper->DoMpiReceive__parent_caller(ns3::Ptr< ns3::Packet  > (p_ptr));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
PyObject *
PyNs3PointToPointNetDevice__PythonHelper::_wrap_DoInitialize(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper = dynamic_cast< PyNs3PointToPointNetDevice__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointNetDevice__PythonHelper::_wrap_NotifyNewAggregate(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper = dynamic_cast< PyNs3PointToPointNetDevice__PythonHelper* >(self->obj);
...
PyObject *
PyNs3PointToPointNetDevice__PythonHelper::_wrap_NotifyConstructionCompleted(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper = dynamic_cast< PyNs3PointToPointNetDevice__PythonHelper* >(self->obj);
...
void
PyNs3PointToPointNetDevice__PythonHelper::DoInitialize()
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Object *self_obj_before;
...
_wrap_PyNs3PointToPointNetDevice__tp_init(PyNs3PointToPointNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (Py_TYPE(self) != &PyNs3PointToPointNetDevice_Type)
    {
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetIfIndex(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetChannel(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::Ptr< ns3::Channel > retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetAddress(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
    PyNs3Address *py_Address;
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetMtu(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint16_t retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_IsLinkUp(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_IsBroadcast(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetBroadcast(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
    PyNs3Address *py_Address;
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_IsMulticast(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_IsPointToPoint(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_IsBridge(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_GetNode(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::Ptr< ns3::Node > retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_NeedsArp(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
_wrap_PyNs3PointToPointNetDevice_SetReceiveCallback(PyNs3PointToPointNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    (helper_class == NULL)? (self->obj->SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<const ns3::Packet>, unsigned short, const ns3::Address &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl))) : (self->obj->ns3::PointToPointNetDevice::SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<const ns3::Packet>, unsigned short, const ns3::Address &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl)));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
_wrap_PyNs3PointToPointNetDevice_SetPromiscReceiveCallback(PyNs3PointToPointNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    (helper_class == NULL)? (self->obj->SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<const ns3::Packet>, unsigned short, const ns3::Address &, const ns3::Address &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl))) : (self->obj->ns3::PointToPointNetDevice::SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<const ns3::Packet>, unsigned short, const ns3::Address &, const ns3::Address &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl)));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
PyObject *
_wrap_PyNs3PointToPointNetDevice_SupportsSendFrom(PyNs3PointToPointNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper_class = dynamic_cast<PyNs3PointToPointNetDevice__PythonHelper*> (self->obj);
...
PyNs3PointToPointNetDevice__tp_traverse(PyNs3PointToPointNetDevice *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj).name() == typeid(PyNs3PointToPointNetDevice__PythonHelper).name()  && self->obj->GetReferenceCount() == 1)
        Py_VISIT((PyObject *) self);
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "point_to_point.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
MOD_INIT(point_to_point)
{
    ...
    /* Import the 'ns3::CallbackImpl< void, ns3::Ptr<const ns3::Packet>, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::NetDevice>, ns3::Time, ns3::Time, ns3::empty, ns3::empty, ns3::empty, ns3::empty >' class from module 'ns.core' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.core");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3CallbackImpl__Void_Ns3Ptr__lt__const_ns3Packet__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Time_Ns3Time_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "CallbackImpl__Void_Ns3Ptr__lt__const_ns3Packet__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Ptr__lt__ns3NetDevice__gt___Ns3Time_Ns3Time_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty");
    ...
    submodule = initpoint_to_point_internal();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
