#include "ns3module.h"
static PyMethodDef virtual_net_device_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef virtual_net_device_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "virtual_net_device.FatalImpl",
    NULL,
    -1,
    virtual_net_device_FatalImpl_functions,
};
#endif

static PyObject *
initvirtual_net_device_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&virtual_net_device_FatalImpl_moduledef);
    #else
    m = Py_InitModule3((char *) "virtual_net_device.FatalImpl", virtual_net_device_FatalImpl_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef virtual_net_device_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef virtual_net_device_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "virtual_net_device.Hash.Function",
    NULL,
    -1,
    virtual_net_device_Hash_Function_functions,
};
#endif

static PyObject *
initvirtual_net_device_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&virtual_net_device_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "virtual_net_device.Hash.Function", virtual_net_device_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef virtual_net_device_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef virtual_net_device_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "virtual_net_device.Hash",
    NULL,
    -1,
    virtual_net_device_Hash_functions,
};
#endif

static PyObject *
initvirtual_net_device_Hash(void)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&virtual_net_device_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "virtual_net_device.Hash", virtual_net_device_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = initvirtual_net_device_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
static PyMethodDef virtual_net_device_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
PyTypeObject *_PyNs3CallbackImpl__Bool_Ns3Ptr__lt__ns3Packet__gt___Const_ns3Address___amp___Const_ns3Address___amp___Unsigned_short_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetAddress(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetBroadcast(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3Address *py_Address;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetIfIndex(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetMtu(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint16_t retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetNode(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_IsBridge(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_IsBroadcast(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_IsLinkUp(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_IsMulticast(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_IsPointToPoint(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3VirtualNetDevice_NeedsArp(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
_wrap_PyNs3VirtualNetDevice_Receive(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    } else if (PyObject_IsInstance(destination, (PyObject*) &PyNs3Mac8Address_Type)) {
        destination2 = *((PyNs3Mac8Address *) destination)->obj;
    } else {
    
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address, Mac48Address, Mac8Address), not %s", Py_TYPE(destination)->tp_name);
        return NULL;
    }
...
PyObject *
_wrap_PyNs3VirtualNetDevice_SupportsSendFrom(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
...
static PyObject*
_wrap_PyNs3VirtualNetDevice__copy__(PyNs3VirtualNetDevice *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject PyNs3VirtualNetDevice_Type = {
    ...
    (char *) "virtual_net_device.VirtualNetDevice",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "virtual_net_device.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "virtual_net_device.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef virtual_net_device_moduledef = {
    PyModuleDef_HEAD_INIT,
    "virtual_net_device",
    NULL,
    -1,
    virtual_net_device_functions,
};
#endif
...
MOD_INIT(virtual_net_device)
{
    PyObject *m;
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&virtual_net_device_moduledef);
    #else
    m = Py_InitModule3((char *) "virtual_net_device", virtual_net_device_functions, NULL);
    #endif
    if (m == NULL) {
        return MOD_ERROR;
    }
    ...
    /* Import the 'ns3::CallbackImpl< bool, ns3::Ptr<ns3::Packet>, const ns3::Address &, const ns3::Address &, unsigned short, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >' class from module 'ns.core' */
    {
        PyObject *module = PyImport_ImportModule((char*) "ns.core");
        if (module == NULL) {
            return MOD_ERROR;
        }
        _PyNs3CallbackImpl__Bool_Ns3Ptr__lt__ns3Packet__gt___Const_ns3Address___amp___Const_ns3Address___amp___Unsigned_short_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Type = (PyTypeObject*) PyObject_GetAttrString(module, (char*) "CallbackImpl__Bool_Ns3Ptr__lt__ns3Packet__gt___Const_ns3Address___amp___Const_ns3Address___amp___Unsigned_short_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty");
    ...
    submodule = initvirtual_net_device_FatalImpl();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
    PyModule_AddObject(m, (char *) "FatalImpl", submodule);
    submodule = initvirtual_net_device_Hash();
    if (submodule == NULL) {
        return MOD_ERROR;
    }
    Py_INCREF(submodule);
